...
def generate_spec(basename, dirname):
  ...
  splitRegex = re.compile(r"""pse-[a-zA-Z0-9]*(s[0-9]*)-[a-zA-Z0-9\.]*-(NONE|PRIORITY|PRIORITY-UDISS|PRIORITY-UDISS-UCACHING|PRIORITY-UDISS-SCACHING)-[0-9]*squads-[0-9A-Za-z\-]*(UDISS1|UDISS2)-security-(off|dynamic|static)-[0-9]*_logs[0-9]*""")
