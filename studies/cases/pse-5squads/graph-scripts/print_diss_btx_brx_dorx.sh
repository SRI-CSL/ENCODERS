...
DO=$(echo $DO | tr ' ' '\n' | awk -f ${DIR}/stats.awk | awk -F, '{print $1/9735., $3/9735, $4/9735;}')

ALLDO=$(cat r*/$1.stats_log | grep -v "name,date" |  awk -F, '{print $9/332235}' | awk -f ${DIR}/stats.awk | awk -F, '{print $1, $3, $4;}')
