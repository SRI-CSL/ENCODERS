#
# Copyright (c) 2012 SRI International and Suns-tech Incorporated and GPC
        ...
        while len(node_script) > 0:
            ...
            if action_type == "pub":
                ...
                if action_file:
                    ...
                    ht_cmd = "haggletest -f %s.houtput %s app%d pub file %s.temp %s" % (my_outputfile, custom_args, app_count, action_file, action_attributes_string)
                    ...
                    ht_cmd = "haggletest -f %s.houtput %s app%d pub %s" % (my_outputfile, custom_args, app_count, action_attributes_string)
                    my_err_outputfile = my_outputfile + ".errcode"
                    last_delay = action_time - prev_time
                ...
                try:
                    ...
                    None
                ht_cmd = "haggletest -a -f %s.houtput -c %s app%d sub %s %s" % (my_outputfile, custom_args, app_count, action_attributes_string, io_redirect)
                last_delay = action_time - prev_time
