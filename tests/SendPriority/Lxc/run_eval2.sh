...
rm -rf ./TestEvaluationFramework/Eval2/*
cd TestEvaluationFramework/TestGenerator
python test_generator.py send_priority_eval2.json
cd ../
ls -d Eval2/* > send_priority_eval2
./testrunner.sh send_priority_eval2 | tee /tmp/output
cd ../
OUTPUT_DIR="send_priority_eval2_results_$(date '+%s')"
mkdir ${OUTPUT_DIR}
