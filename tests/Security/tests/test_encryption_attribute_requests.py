...
"""
Encryption Attribute Requests: Tests whether encryption attribute requests work correctly. Also tests whether encryption works.
...
This should succeed.
There should be a request for the encryption attribute.
"""
