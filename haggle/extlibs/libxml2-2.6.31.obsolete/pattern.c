...
#define PATTERN_ERROR(a, b, c, d)
#define PATTERN_ERROR5(a, b, c, d, e)
...
xmlCompileAttributeTest(xmlPatParserContextPtr ctxt) {
	...
	if (IS_BLANK_CH(CUR)) {	    
	    PATTERN_ERROR5(NULL, NULL, NULL, "Invalid QName.\n", NULL);
